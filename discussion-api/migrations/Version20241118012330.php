 ...
 */
final class Version20241118012330 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE discussion (uuid UUID NOT NULL, PRIMARY KEY(uuid))');
        $this->addSql('COMMENT ON COLUMN discussion.uuid IS \'(DC2Type:uuid)\'');
